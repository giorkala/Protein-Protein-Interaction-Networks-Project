...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Schizosaccharomyces_pombe_972h.edgelist","r");
    distances=fopen("DistMats/Schizosaccharomyces_pombe_972h-Distances.txt","w");
    char line[12];
