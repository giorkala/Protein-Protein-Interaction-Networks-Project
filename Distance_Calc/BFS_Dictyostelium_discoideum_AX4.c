...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Dictyostelium_discoideum_AX4.edgelist","r");
    distances=fopen("DistMats/Dictyostelium_discoideum_AX4-Distances.txt","w");
    char line[12];
