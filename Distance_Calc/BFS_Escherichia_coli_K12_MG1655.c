...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Escherichia_coli_K12_MG1655.edgelist","r");
    distances=fopen("DistMats/Escherichia_coli_K12_MG1655-Distances.txt","w");
    char line[12];
