...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Saccharomyces_cerevisiae_S288c.edgelist","r");
    distances=fopen("DistMats/Saccharomyces_cerevisiae_S288c-Distances.txt","w");
    char line[12];
