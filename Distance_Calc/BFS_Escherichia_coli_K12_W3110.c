...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Escherichia_coli_K12_W3110.edgelist","r");
    distances=fopen("DistMats/Escherichia_coli_K12_W3110-Distances.txt","w");
    char line[12];
