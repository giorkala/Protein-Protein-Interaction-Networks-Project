...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Plasmodium_falciparum_3D7.edgelist","r");
    distances=fopen("DistMats/Plasmodium_falciparum_3D7-Distances.txt","w");
    char line[12];
