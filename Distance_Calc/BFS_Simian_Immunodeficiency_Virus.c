...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Simian_Immunodeficiency_Virus.edgelist","r");
    distances=fopen("DistMats/Simian_Immunodeficiency_Virus-Distances.txt","w");
    char line[12];
