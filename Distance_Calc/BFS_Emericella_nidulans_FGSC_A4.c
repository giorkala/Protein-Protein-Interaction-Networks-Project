...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Emericella_nidulans_FGSC_A4.edgelist","r");
    distances=fopen("DistMats/Emericella_nidulans_FGSC_A4-Distances.txt","w");
    char line[12];
