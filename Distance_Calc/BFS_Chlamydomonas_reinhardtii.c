...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Chlamydomonas_reinhardtii.edgelist","r");
    distances=fopen("DistMats/Chlamydomonas_reinhardtii-Distances.txt","w");
    char line[12];
