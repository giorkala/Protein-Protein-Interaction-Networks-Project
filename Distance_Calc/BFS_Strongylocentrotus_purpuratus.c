...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Strongylocentrotus_purpuratus.edgelist","r");
    distances=fopen("DistMats/Strongylocentrotus_purpuratus-Distances.txt","w");
    char line[12];
