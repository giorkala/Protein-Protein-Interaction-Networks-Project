...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Nicotiana_tomentosiformis.edgelist","r");
    distances=fopen("DistMats/Nicotiana_tomentosiformis-Distances.txt","w");
    char line[12];
