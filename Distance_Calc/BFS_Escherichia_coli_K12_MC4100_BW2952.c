...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Escherichia_coli_K12_MC4100_BW2952.edgelist","r");
    distances=fopen("DistMats/Escherichia_coli_K12_MC4100_BW2952-Distances.txt","w");
    char line[12];
