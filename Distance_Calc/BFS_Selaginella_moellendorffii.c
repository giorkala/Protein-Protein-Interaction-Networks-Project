...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Selaginella_moellendorffii.edgelist","r");
    distances=fopen("DistMats/Selaginella_moellendorffii-Distances.txt","w");
    char line[12];
