...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Mycobacterium_tuberculosis_H37Rv.edgelist","r");
    distances=fopen("DistMats/Mycobacterium_tuberculosis_H37Rv-Distances.txt","w");
    char line[12];
