...
int main()
{
    ...
    FILE* edges;
    FILE* distances;
    edges=fopen("../PPIN_Construction/EdgeLists_Relabeled/Human_Immunodeficiency_Virus_1.edgelist","r");
    distances=fopen("DistMats/Human_Immunodeficiency_Virus_1-Distances.txt","w");
    char line[12];
